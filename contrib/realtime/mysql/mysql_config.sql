...
-- Running upgrade e658c26033ca -> 61797b9fced6

ALTER TABLE ps_endpoints ADD COLUMN stir_shaken ENUM('0','1','off','on','false','true','no','yes');

UPDATE alembic_version SET version_num='61797b9fced6' WHERE alembic_version.version_num = 'e658c26033ca';

-- Running upgrade 61797b9fced6 -> 8915fcc5766f

ALTER TABLE queue_members ADD COLUMN ringinuse ENUM('0','1','off','on','false','true','no','yes');

UPDATE alembic_version SET version_num='8915fcc5766f' WHERE alembic_version.version_num = '61797b9fced6';
...
-- Running upgrade 7197536bb68d -> a062185f355c

ALTER TABLE ps_endpoints ADD COLUMN stir_shaken_profile VARCHAR(80);

UPDATE alembic_version SET version_num='a062185f355c' WHERE alembic_version.version_num = '7197536bb68d';

-- Running upgrade a062185f355c -> 539f68bede2c

ALTER TABLE ps_endpoints MODIFY `100rel` ENUM('no','required','peer_supported','yes') NULL;

UPDATE alembic_version SET version_num='539f68bede2c' WHERE alembic_version.version_num = 'a062185f355c';
