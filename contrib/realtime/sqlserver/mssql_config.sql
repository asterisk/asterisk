...
CREATE TABLE ps_endpoints (
    ...
    callgroup VARCHAR(40) NULL, 
    pickupgroup VARCHAR(40) NULL, 
    namedcallgroup VARCHAR(40) NULL, 
    namedpickupgroup VARCHAR(40) NULL, 
    devicestate_busy_at INTEGER NULL, 
    faxdetect VARCHAR(3) NULL, 
    t38udptl VARCHAR(3) NULL, 
    t38udptl_ec VARCHAR(10) NULL, 
    t38udptl_maxdatagram INTEGER NULL, 
    t38udptl_nat VARCHAR(3) NULL, 
    t38udptl_ipv6 VARCHAR(3) NULL, 
    tonezone VARCHAR(40) NULL, 
    language VARCHAR(40) NULL, 
    one_touch_recording VARCHAR(3) NULL, 
    recordonfeature VARCHAR(40) NULL, 
    recordofffeature VARCHAR(40) NULL, 
    rtpengine VARCHAR(40) NULL, 
    allowtransfer VARCHAR(3) NULL, 
    allowsubscribe VARCHAR(3) NULL, 
    sdpowner VARCHAR(40) NULL, 
    sdpsession VARCHAR(40) NULL, 
    tos_audio INTEGER NULL, 
    tos_video INTEGER NULL, 
    cos_audio INTEGER NULL, 
    cos_video INTEGER NULL, 
    subminexpiry INTEGER NULL, 
    fromdomain VARCHAR(40) NULL, 
    fromuser VARCHAR(40) NULL, 
    mwifromuser VARCHAR(40) NULL, 
    dtlsverify VARCHAR(40) NULL, 
    dtlsrekey VARCHAR(40) NULL, 
    dtlscertfile VARCHAR(200) NULL, 
    dtlsprivatekey VARCHAR(200) NULL, 
    dtlscipher VARCHAR(200) NULL, 
    dtlscafile VARCHAR(200) NULL, 
    dtlscapath VARCHAR(200) NULL, 
    dtlssetup VARCHAR(7) NULL, 
