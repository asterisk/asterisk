...
/* Defines an identifier for the left channel audio channel. */
#define IMPULSE_CHANNEL_LEFT 0
/* Defines an identifier for the right channel audio channel. */
