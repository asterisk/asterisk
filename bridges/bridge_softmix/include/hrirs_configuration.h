...
#ifndef _ASTERISK_IMPULSES_H
#define _ASTERISK_IMPULSES_H
...
#if POSITION_SIZE != HRIRS_IMPULSE_SIZE / 2
#error "The conference is designed for 180 individual places at the moment. If you want to change this please alter the positions array first"
#endif
