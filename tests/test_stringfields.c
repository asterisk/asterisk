...
AST_TEST_DEFINE(string_field_test)
{
	...
	ast_string_field_free(&test_struct2, AST_STRINGFIELD_CLEANUP_FREE_POOLS);
	ast_string_field_free(&test_struct, AST_STRINGFIELD_CLEANUP_FREE_POOLS);
...
AST_TEST_DEFINE(string_field_aggregate_test)
{
	...
	ast_string_field_free(inst1, AST_STRINGFIELD_CLEANUP_RESET);
	ast_string_field_free(inst2, AST_STRINGFIELD_CLEANUP_RESET);
	ast_string_field_free(inst3, AST_STRINGFIELD_CLEANUP_RESET);
	ast_string_field_free(inst4, AST_STRINGFIELD_CLEANUP_RESET);
...
error:
	ast_string_field_free(inst1, AST_STRINGFIELD_CLEANUP_FREE_ALL);
	ast_string_field_free(inst2, AST_STRINGFIELD_CLEANUP_FREE_ALL);
	ast_string_field_free(inst3, AST_STRINGFIELD_CLEANUP_FREE_ALL);
	ast_string_field_free(inst4, AST_STRINGFIELD_CLEANUP_FREE_ALL);
