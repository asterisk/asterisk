...
/*** DOCUMENTATION
	<configInfo name="res_pjproject" language="en_US">
		...
		<configFile name="pjproject.conf">
			<configObject name="boot">
				<synopsis>Asterisk boot time options for PJPROJECT</synopsis>
				<description>
					<note><para>The id of this object, as well as its type, must be
					'boot' or it won't be found.</para></note>
				</description>
				<configOption name="type">
					<synopsis>Must be of type 'boot'.</synopsis>
				</configOption>
				<configOption name="log_level" default="2">
					...
					<note><para>
						This option is needed very early in the boot process
