...
#define ast_res_pjsip_init_options_handling(reload) \
	__ast_res_pjsip_init_options_handling(reload, ast_module_info)
int __ast_res_pjsip_init_options_handling(int reload, const struct ast_module_info *ast_module_info);
