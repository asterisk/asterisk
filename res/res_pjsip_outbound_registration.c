			...
			<configObject name="registration">
				...
				<configOption name="fatal_retry_interval" default="0">
					...
					<description><para>
						...
						<note><para>When receiving a 403 forbidden response, if the
                                                <replaceable>forbidden_retry_interval</replaceable> is set it takes precedence
                                                over this option.</para></note>
					</description>
				</configOption>
