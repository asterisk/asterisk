...
static void queue_set_global_params(struct ast_config *cfg)
{
	...
	if ((general_val = ast_variable_retrieve(cfg, "general", "force_longest_waiting_caller"))) {
	 ...
	 // Apply enable_cidname_logging in the same place as other global settings
    if ((general_val = ast_variable_retrieve(cfg, "general", "enable_cidname_logging"))) {
        enable_cidname_logging = ast_true(general_val);
    }
}
