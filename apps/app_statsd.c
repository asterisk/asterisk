...
/*** DOCUMENTATION
	<application name="Statsd" language="en_US">
		...
		<description>
			...
			specified inside of statsd.conf.</para>
		</description>
	</application>
 ***/
...
AST_MODULE_INFO_STANDARD(ASTERISK_GPL_KEY, "Statsd Dialplan Application");