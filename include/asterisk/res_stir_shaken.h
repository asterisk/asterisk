...
enum ast_stir_shaken_failure_action {
	/*! Unknown value */
	AST_STIR_SHAKEN_VS_FAILURE_UNKNOWN = -1,
	/*! Not set in config */
	AST_STIR_SHAKEN_VS_FAILURE_NOT_SET = 0,
	/*! Continue and let dialplan decide action */
	AST_STIR_SHAKEN_VS_FAILURE_CONTINUE,
	/*! Reject request with respone codes defined in RFC8224 */
	AST_STIR_SHAKEN_VS_FAILURE_REJECT_REQUEST,
	/*! Continue but return a Reason header in next provisional response  */
	AST_STIR_SHAKEN_VS_FAILURE_CONTINUE_RETURN_REASON,
};
