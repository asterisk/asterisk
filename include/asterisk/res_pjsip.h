...
/*!
 * \brief Task types for the res_pjsip scheduler
 */
enum ast_sip_scheduler_task_flags {
	...
	AST_SIP_SCHED_TASK_DATA_MASK = (0x03 << 1),
	/*!
	 * Don't take any cleanup action on the data
	 */
	AST_SIP_SCHED_TASK_DATA_NO_CLEANUP = (0 << 1),
	/*!
	 * The task data is an ao2 object and should be dereferenced
	 * when the task runs for the final time (if ever).
	 */
	AST_SIP_SCHED_TASK_DATA_UNREF = (1 << 1),
	/*!
	 * The task data was malloc'd and should be freed
	 * when the task runs for the final time (if ever).
	 */
	AST_SIP_SCHED_TASK_DATA_FREE = ( 2 << 1 ),
