 ...
 * \since 12
 */
#define stasis_topic_create(name) stasis_topic_create_debug((name), NULL);
struct stasis_topic *stasis_topic_create_debug(const char *name, void *debugstorage);
...
#define stasis_caching_topic_create(original_topic, cache) \
	stasis_caching_topic_create_debug((original_topic), (cache), NULL)
