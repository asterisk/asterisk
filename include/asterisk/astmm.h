...
/*!
 * \brief ASTMM_LIBC can be defined to control the meaning of stanard allocators.
 *
 ...
 *
 * \note This option is used in some cases instead of changing existing
 * source to use Asterisk functions.  New code should generally avoid
 * this option, except where it's needed to 
 */
