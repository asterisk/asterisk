...
Each of reference manipulation will generate one line of output in in the refs
...
#define __ao2_callback(c, flags, cb_fn, arg, tag, file, line, func) \
	__ao2_traverse(c, flags, cb_fn, arg, NULL, AO2_CALLBACK_DEFAULT, \
		tag, file, line, func)
...
#define __ao2_callback_data(c, flags, cb_fn, arg, data, tag, file, line, func) \
	__ao2_traverse(c, flags, cb_fn, arg, data, AO2_CALLBACK_WITH_DATA, \
		tag, file, line, func)
