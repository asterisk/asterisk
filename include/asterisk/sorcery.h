 ...
 * \param module The name of the module, typically AST_MODULE
 * \param position An index to remove or one of ast_sorcery_wizard_position
 *
 * \retval 0 success
 * \retval -1 failure
 *
 ...
 * \since 13.4.0
 */
#define ast_sorcery_remove_wizard_mapping(sorcery, type, position) \
	__ast_sorcery_remove_wizard_mapping((sorcery), (type), AST_MODULE, (position))
