 ...
 * \retval 0 on success.
 * \retval -1 on error.
 * \retval 1 (AST_MODULE_LOAD_DECLINE) if there's already another provider registered.
 */
 ...
 * \retval 0 on success.
 * \retval -1 on error.
 * \retval 1 (AST_MODULE_LOAD_DECLINE) if there's already another greeter registered.
 */
