...
static int ast_cdr_generic_register(struct be_list *generic_list, const char *name, const char *desc, ast_cdrbe be)
{
	struct cdr_beitem *i = NULL;
...
{
	return ast_cdr_generic_register(&be_list, name, desc, be);
}

int ast_cdr_modifier_register(const char *name, const char *desc, ast_cdrbe be)
{
	return ast_cdr_generic_register((struct be_list *)&mo_list, name, desc, be);
}
