...
static int silk_samples(struct ast_frame *frame)
{
	 ...
	 * sample rate of the codec and the expected number of samples to receive in a 20ms
	 * timeframe, based on the assumption of 1 byte samples. In testing, this has worked
	 * just fine.
	 */
