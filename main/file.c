...
/* Protected by the formats list lock */
 ...
 *
 * \note You must hold the formats list lock when calling this function
 *
 ...
 *
 * \retval An allocated string large enough to accomodate all registered filename
