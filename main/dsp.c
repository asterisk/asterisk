...
static int test_dtmf_twist_sweep(struct ast_test *test, struct ast_dsp *dsp, int digit_index)
{
	...
	struct {
		 ...
		 */
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1800, .digit = 0, },
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1700, .digit = 0, },
		/* Various digits detect and not detect in this range */
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1400, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1300, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1200, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1100, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +    0, .amp_col = 1000 + 1000, .digit = dtmf_positions[digit_index], },
		...
		{ .amp_row = 1000 +  200, .amp_col = 1000 +    0, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +  300, .amp_col = 1000 +    0, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +  400, .amp_col = 1000 +    0, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +  500, .amp_col = 1000 +    0, .digit = dtmf_positions[digit_index], },
		{ .amp_row = 1000 +  550, .amp_col = 1000 +    0, .digit = dtmf_positions[digit_index], },
		/* Various digits detect and not detect in this range */
		{ .amp_row = 1000 +  650, .amp_col = 1000 +    0, .digit = 0, },
		{ .amp_row = 1000 +  700, .amp_col = 1000 +    0, .digit = 0, },
		{ .amp_row = 1000 +  800, .amp_col = 1000 +    0, .digit = 0, },
	};
