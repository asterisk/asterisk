...
void ast_rtp_codecs_payloads_copy(struct ast_rtp_codecs *src, struct ast_rtp_codecs *dest, struct ast_rtp_instance *instance)
{
	...
	/* This represents a completely new mapping of what the remote party is expecting for payloads,
	 * so we clear out the entire tx payload mapping vector and replace it.
	 */
