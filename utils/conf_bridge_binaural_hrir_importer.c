...
int main (int argc, char **argv)
{
	...
	if(argc != 4) {
		...
		puts("Example: conf_bridge_binaural_hrir_importer hrirs.wav 0 179 > ../bridges/bridge_softmix/include/hrirs.h");
		return -1;
	}
	...
	hrir_data = malloc(hrir_info.channels * hrir_info.frames * sizeof (float));
	if(hrir_data == NULL) {
