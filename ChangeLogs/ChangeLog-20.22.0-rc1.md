...
### Links:
 ...
 - [Full ChangeLog](https://downloads.asterisk.org/pub/telephony/asterisk/releases/ChangeLog-20.22.0-rc1.html)  
 - [GitHub Diff](https://github.com/asterisk/asterisk/compare/20.21.0...20.22.0-rc1)  
 - [Tarball](https://downloads.asterisk.org/pub/telephony/asterisk/asterisk-20.22.0-rc1.tar.gz)  
...
- #### chan_sip: Address Session Timer RFC compliance issues
  Two new global parameters have been added to
  chan_sip. `session-ignore-se-increase` and
  `session-include-in-provisional` can be used to influence how Asterisk
  handles Session Timers. See sip.conf.sample for more information.
...
### Closed Issues:
  ...
  - #2103: [bug]: chan_sip honors increased session timer refresh interval from UAS
  - #2104: [bug]: chan_sip includes Session-Expires header in provisional responses
...
__chan_sip: Address Session Timer RFC compliance issues__
  Author: Sean Bright
  Date:   2026-08-12

  This commit addresses 2 issues with chan_sip's behavior as it relates
  to RFC 4028 (Session Timers):

  1. When acting as a UAC, if Asterisk receives a response from the UAS
     that increases the Session-Expires refresh interval, Asterisk will
     honor that increase. This is not compliant with RFC 4028 Section 9.

  2. When acting as a UAS, Asterisk includes the Session-Expires header
     in provisional responses (1xx) which is not specified by RFC 4028.

  This commit introduces 2 new global parameters to sip.conf to change
  this behavior. Asterisk's default behavior (as specified above)
  remains unchanged.

  Resolves: #2103
  Resolves: #2104

  UserNote: Two new global parameters have been added to
  chan_sip. `session-ignore-se-increase` and
  `session-include-in-provisional` can be used to influence how Asterisk
  handles Session Timers. See sip.conf.sample for more information.
